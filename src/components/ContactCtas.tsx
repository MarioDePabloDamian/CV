...
export const ContactCtas: React.FC<ContactCtasProps> = ({
  ...
  if (layout === "footer") {
    return (
      <a
        href={mailto}
        className="inline-flex items-center justify-center gap-2 max-w-full px-4 sm:px-5 py-2.5 rounded-lg bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white text-sm sm:text-base font-semibold transition-colors break-all"
      >
