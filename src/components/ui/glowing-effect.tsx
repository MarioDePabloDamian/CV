    ...
    const handleMove = useCallback(
      (e?: MouseEvent | { x: number; y: number }) => {
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          // El efecto solo se muestra cuando el mouse está cerca
          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle, #0ea5e9 30%, #0ea5e900 50%),
                radial-gradient(circle at 40% 40%, #38bdf8 25%, #38bdf800 45%),
                radial-gradient(circle at 60% 60%, #0284c7 30%, #0284c700 50%), 
                radial-gradient(circle at 40% 60%, #0369a1 30%, #0369a100 50%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #0ea5e9 0%,
